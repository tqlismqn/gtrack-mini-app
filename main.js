...
function renderDriverList() {
  ...
  state.filteredDrivers.forEach((driver) => {
    ...
    nameCell.innerHTML = `<strong>${getDriverFullName(driver)}</strong><div class="text-muted">${driver.personal.email || "—"}</div>`;
    ...
    locationCell.innerHTML = `${WORK_LOCATION_LABELS[driver.work.workLocation] || "—"}<div class="text-muted">${driver.work.workAddress || ""}</div>`;
    ...
    contactCell.innerHTML = `${driver.personal.phone || "—"}`;
